...
<body>
    <form id="form1" runat="server">
        <div id="container">
            ...
            <div id="cont_login">
                 <div class="log_title" style="font-size:18px; font-weight:bold;"><%=Resources.CRMTreeLogin.Privacy_Title %></div>
                <div class="lg_Contbox">
                    <div class="Body" style="font-size:14px;"><%=Resources.CRMTreeLogin.Privacy_Cont1 %></div>
                    <div class="Title" > <%=Resources.CRMTreeLogin.Privacy_Title2 %></div>
                    <div class="Body"><%=Resources.CRMTreeLogin.Privacy_Cont2 %></div>
                    <div class="Title" > <%=Resources.CRMTreeLogin.Privacy_Title3 %></div>
                    <div class="Body"><%=Resources.CRMTreeLogin.Privacy_Cont3 %></div>
                 </div>
            </div>
