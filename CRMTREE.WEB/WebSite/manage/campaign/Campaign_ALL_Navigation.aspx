<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Campaign_ALL_Navigation.aspx.cs" Inherits="manage_campaign_Campaign_ALL_Navigation" %>
...
<script type="text/javascript">
    ...
    _params.CA = _params.CA > 0 ? _params.CA : '';
    ...
    _campaign_all = {
        $tabs: $("#c_tabs_camp"),
        _cg_code: 0,
        _url_campaign:"/manage/campaign/Campaign.aspx?CA=" + _params.CA,
        ...
        addNoT: function (ct) {
            if (ct > 0) {
                window.top.location.href = _campaign_all._url_campaign + "&CT=" + ct;
            }
        },
        add: function (ct) {
            if (ct > 0) {
                window.top.location.href = _campaign_all._url_campaign + "&T=2&CT=" + ct;
            }
        },
        edit: function () {
            var cg_code = _campaign_all.get_cg_code();
            if (cg_code > 0) {
                window.top.location.href = _campaign_all._url_campaign + "&T=2&CG_Code=" + cg_code;
            }
        },
        use: function () {
            var cg_code = _campaign_all.get_cg_code();
            if (cg_code > 0) {
                window.top.location.href = _campaign_all._url_campaign + "&T=1&CG_Code=" + cg_code;
            }
        },
        remove: function () {
        ...
        bind: function () {
            ...
            var params = { action: 'Get_Campaign_All', P_ID: pid ,CA:cat};
