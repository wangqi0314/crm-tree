<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_campaign.aspx.cs" Inherits="manage_campaign_edit_campaign" %>
...
<head>
    ...
    <script type="text/javascript" src="/scripts/manage/campaign/edit_campaign.js"></script>
    ...
    <title><%= Resources.CRMTREESResource.CampaignEdit %></title>
    <style type="text/css">
         .succ_Matri_L {
...
<body>
    <form id="form1" runat="server">
        <div id="container">
            ...
            <div id="content">
                <div class="nav_infor">
                    <a class="brown" href="/manage/campaign/list_campaign.aspx"><%= Resources.CRMTREESResource.CampaignList %></a>
                    >
                    <%= Resources.CRMTREESResource.CampaignEdit %>
                </div>
                <div class="cont_box">
                    <div class="cont_list" id="Information1">
                        <div class="report_title"><%= Resources.CRMTREESResource.CampaignBasicInformation %></div>
                        <input type="hidden" id="input_hid_CG_UType" value="<%=Campaign.CG_UType %>" />
                        <input type="hidden" id="input_hid_AU_Type" value="<%=AU_Type %>" />
                        <input type="hidden" id="input_hid_UG_Code" value="<%=UG_Code %>" />
                        <table width="100%" cellpadding="0" cellspacing="0" style="margin: auto;">
                            <%-- 活动标题--%>
                            <tr>
                                <td class="table_title" width="22%">
                                    <span class="red">*</span><%= Resources.CRMTREESResource.CampaignTitle %>
                                </td>
                                <td class="table_cont" width="78%">
                                    <input class="input_text_w400 js_enter" id="txt_title" name="txt_title" maxlength="50" value="<%= Campaign.CG_Title %>" />
                                    <span id="sp_title" class="red" style="display: none;">
                                        <%= Resources.CRMTREESResource.CampaginCon8 %></span>
                                    <input id="input_checkbox_Share" type="checkbox" /><lable class="share"><%=Resources.CRMTREESResource.CampaignShare %></lable>
                                    <input id="input_checkbox_active" type="checkbox" style="display: none" /><lable class="active" style="display: none"><%=Resources.CRMTREESResource.CampaignActive %></lable>
                                    <input type="hidden" id="input_hid_Share" value="<%=Campaign.CG_Share %>" />
                                    <input type="hidden" id="input_hid_active" value="<%=Campaign.CG_Active_Tag %>" />
                                </td>
                            </tr>
                            <%-- 活动描述--%>
                            <tr>
                                <td class="table_title" style="vertical-align: top;"><span class="red">*</span><%= Resources.CRMTREESResource.CampaignDescription %></td>
                                <td class="table_cont">
                                    <textarea class="input_textarea_wAuto98 js_enter" id="txt_desc" name="txt_desc" cols="48" rows="5"><%=Campaign.CG_Desc %></textarea>
                                    <span id="sp_desc" class="red" style="display: none;">
                                        <%= Resources.CRMTREESResource.CampaginCon9 %>
                                    </span>
                                </td>
                            </tr>
                            <%-- 活动类型--%>
                            <tr>
                                <td class="table_title"><span class="red">*</span><%= Resources.CRMTREESResource.CampaignType %></td>
                                <td class="table_cont">
                                    <input type="hidden" id="hid_type" value="<%=Campaign.CG_Type %>" />
                                    <div style="float: left; margin-right: 10px; border-radius: 4px; border: 1px solid #d2d2d2; width: 230px;">
                                        <p style="text-align: center; margin-left: 20px; font-weight: bold">
                                            <%= Resources.CRMTREESResource.CampaignSales %>
                                        </p>
                                        <p>
                                            <label>
                                                <input type="radio" name="Sales_type" value="1" id="Sales_type_1" />
                                                <%=Resources.CRMTREESResource.CampaignSalesCam %>
                                            </label>
                                            <label>
                                                <input type="radio" name="Sales_type" value="2" id="Sales_type_2" />
                                                <%= Resources.CRMTREESResource.CampaginSurveySur %>
                                            </label>
                                        </p>
                                    </div>
                                    <div style="float: left; margin-right: 10px; border-radius: 4px; border: 1px solid #d2d2d2; width: 230px;">
                                        <p style="text-align: center; margin-left: 20px; font-weight: bold;">
                                            <%= Resources.CRMTREESResource.CampaignService %>
                                        </p>
                                        <p>
                                            <label>
                                                <input type="radio" name="Sales_type" checked="checked" value="3" id="Sales_type_3" />
                                                <%=Resources.CRMTREESResource.CampaignSalesCam %>
                                            </label>
                                            <label>
                                                <input type="radio" name="Sales_type" value="4" id="Sales_type_4" />
                                                <%= Resources.CRMTREESResource.CampaginSurveySur %>
                                            </label>
                                        </p>
                                    </div>
                            ...
                            <tr>
                                <td class="table_title">
                                    <span class="red">*</span><%= Resources.CRMTREESResource.Campaignfrequency %>
                                </td>
                                <td class="table_cont">
                                    <input type="hidden" id="hid_type_time" value="<%=Campaign.CG_Type_Frequency %>" />
                                    <label>
                                        <input type="radio" name="radbtn_type_time" value="1" id="radbtn_type_time_1" checked="checked" class="js_enter" />
                                        <%= Resources.CRMTREESResource.Campaignday %>
                                    </label>
                                    <label>
                                        <input type="radio" name="radbtn_type_time" value="0" id="radbtn_type_time_0" class="js_enter" />
                                        <%= Resources.CRMTREESResource.Campaigntime %>
                                    </label>
                                    <span id="sp_Type_time" style="display: none;">
                                        <input id="txt_Start_dt" class="input_text Wdate js_enter" type="text" onfocus="WdatePicker({lang: 'en', dateFmt: 'MM/dd/yyyy', minDate: '%y-%M-%d'})" value="<%=Campaign.CG_Start_Dt.ToString("MM/dd/yyyy") %>" />
                                        -
                                        <input id="txt_End_dt" class="input_text Wdate js_enter" type="text" onfocus="WdatePicker({lang: 'en', dateFmt: 'MM/dd/yyyy', minDate:'#F{$dp.$D(\'txt_Start_dt\')}'})" value="<%=Campaign.CG_End_Dt.ToString("MM/dd/yyyy") %>" />
                                        <span id="sp_type_time" class="red" style="display: none;"><%= Resources.CRMTREESResource.CampaginCon7 %></span>
                                    </span>
                                </td>
                            </tr>
                            <%-- 方法--%>
                            <tr>
                                ...
                                <td class="table_cont">
                                    <div style="float: left; margin-right: 10px; border-radius: 4px; border: 1px solid #d2d2d2; width: 230px;">
                                        <input type="hidden" id="hid_method" value="<%=Campaign.CG_Method %>" />
                                        <p style="text-align: center; font-weight: bold;"><%= Resources.CRMTREESResource.CampaignPhoneCalls %></p>
                                        <label>
                                            <input type="checkbox" name="ckb_method" value="1" id="ckb_method_1" class="js_enter" />
                                            <%= Resources.CRMTREESResource.CampaignInperson %>
                                        </label>
                                        <label>
                                            <input type="checkbox" name="ckb_method" value="2" id="ckb_method_2" class="js_enter" /><%= Resources.CRMTREESResource.CampaignAutomated %>
                                        </label>
                                        <br />
                                        <span id="sp_person" style="display: none;">
                                            <input type="hidden" id="hid_Whom" value="<%=Campaign.CG_Whom %>" />
                                            <label>
                                    ...
                                    <div style="float: left; margin-right: 10px; border-radius: 4px; border: 1px solid #d2d2d2; width: 300px;">
                                        <p style="text-align: center; font-weight: bold;"><%= Resources.CRMTREESResource.CampaignText %></p>
                                        <label>
                                            <input type="hidden" id="hid_Mess_Type" value="<%=Campaign.CG_Mess_Type %>" />
                                    ...
                                    <div style="float: left; margin-right: 4px; border-radius: 4px; border: 1px solid #d2d2d2; width: 130px;">
                                        <p style="text-align: center; font-weight: bold;"><%= Resources.CRMTREESResource.CampaignText %></p>
                                        <label>
                                        ...
                                        <br />
                                        <label>
                                            <input type="checkbox" name="ckb_method" value="8" id="ckb_method_8" class="js_enter" />
                                            <%= Resources.CRMTREESResource.CampaginDekuApp %>
                                        </label>
                                    </div>
                                </td>
                            </tr>
                            <%-- 客户目标--%>
                            <tr>
                                <td class="table_title"><span class="red">*</span><%= Resources.CRMTREESResource.CampaginCT %></td>
                                <td class="table_cont">
                                    <input type="hidden" id="hid_Targeted" />
                                    <select id="ddl_Targeted" class="js_enter" style="width: 500px;">
                                        <option value="0"><%= Resources.CRMTREESResource.CampaginCon3 %></option>
                                        <%=strDLL_Option %>
                                    </select>&nbsp;&nbsp;<input type="button" value="<%= Resources.CRMTREESResource.CampaginUpdate %>" class="menu_submit_small" id="btnTargeted" style="height: 20px; width: 60px;" />
                                    <br />
                                    <span id="sp_Targeted" class="red" style="display: none;"><%= Resources.CRMTREESResource.CampSelectTarget %> </span>
                            ...
                            <%-- 成功竞选模型--%>
                            <tr>
                                <td class="table_title"><span class="red">*</span><%= Resources.CRMTREESResource.CampaginSM %></td>
                                <td class="table_cont">
                                    <input type="hidden" id="hid_Succ" value="<%=Campaign.CG_Succ_Matrix %>" />
                                   <%-- <select id="ddl_Succ" class="js_enter">
                                        <%=strDLL_Succ %>
                                    </select>
                                    <br />--%>
                            ...
                            <%-- Campagin消息文件名--%>
                            <tr>
                                <td class="table_title"><span class="red">*</span><%= Resources.CRMTREESResource.CampaginCon4 %></td>
                                <td class="table_cont">
                                    ...
                                    <input type="hidden" id="hdFileNmae" name="hdFileNmae" value="<%=Campaign.CG_Filename %>" />
                                    <div id="divprogressGroup"></div>
                                    <br />
                                    <span id="sp_File" class="red" style="display: none;"><%= Resources.CRMTREESResource.CampProvideFile %></span>
                                </td>
                            </tr>
                        </table>
                    </div>
                    <div class="detail_menu StdBtn1">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="javascript: history.go(-1);"><%= Resources.CRMTREESResource.CampagonBL %></a>
                    </div>
                </div>
            </div>
