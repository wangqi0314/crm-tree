<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Camp2_Edit.aspx.cs" Inherits="manage_campaign_Camp2_Edit" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="/scripts/manage/campaign/Camp2_Edit.js"></script>
...
<body>
                ...
                <div class="cont_box">
                    <div class="cont_list" id="Information1">
                        ...
                        <table cellpadding="0" cellspacing="0" style="width: 100%; margin: auto;">
                            <%-- 事件标题--%>
                            <tr>
                                <td class="table_title" style="width:180px;">
                                    <span class="red">*</span><%= Resources.CRMTREESResource.CampaignTitle %>
                                </td>
                                <td class="table_cont" style="width:500px;">
                                    <input class="input_text_w400 js_enter" id="txt_title" style="width:98%;" name="txt_title" maxlength="50" value="<%=Event.EV_Title %>" />
                                ...
                                <td rowspan="2" style="vertical-align:top;padding:0;"> 
                                    <div id="pnl_status" class="easyui-panel" data-options="title:'Status: '" style="width:100%;height:230px;" >
                                        <div class="easyui-layout" data-options="fit:true">
                                            <div data-options="region:'north',border:false" style="height:30px;padding-left:10px;border-bottom:1px solid #B1C242;">
                                                <input id="input_checkbox_Share" type="checkbox" /><lable class="share"><%=Resources.CRMTREESResource.CampaignShare %></lable>
                                                <div style="display:none;"><input id="input_checkbox_active" type="checkbox" /><lable class="active"><%=Resources.CRMTREESResource.CampaignActive %></lable></div>
                                                <input type="hidden" id="input_hid_Share" value="<%=Event.EV_Share %>" />
                                                <input type="hidden" id="input_hid_active" value="<%=Event.EV_Active_Tag %>" />
                                            </div>
                                            <div data-options="region:'center',title:'Approval Process',border:false" style="position:relative;padding:5px;overflow-y:scroll;">
                                                <div id="acc_users" class="easyui-accordion" data-options="multiple:false,selected:null" >
                            ...
                            <%-- 事件描述--%>
                            <tr>
                                <td class="table_title" style="vertical-align: top;">
                                    <span class="red">*</span><%= Resources.CRMTREESResource.CampaignDescription %>
                                </td>
                                <td class="table_cont">
                                    <textarea class="input_textarea_wAuto98 js_enter boders" id="txt_desc" style="height:180px;width:98%;"
                                        name="txt_desc" cols="48" rows="8"><%=Event.EV_Desc %></textarea>
                            ...
                            <%-- 事件方法--%>
                            <tr>
                                <td class="table_title"><span class="red">*</span><%=Resources.CRMTREESResource.EventContact %> <%= Resources.CRMTREESResource.CampaignMethod %>></td>
                                <td class="table_cont" colspan="2">
                                    <div class="Meth_s">
                            ...
                            <tr>
                                ...
                                <td class="table_cont" colspan="2">
                                    ...
                                    <div style="float: left; margin-right: 10px;">
                                       Max # of Attendees <input class="easyui-textbox"/>
                                    </div>
                                </td>
                            </tr>
                            <%-- 相应人员--%>
                            ...
                            <tr>
                                <td class="table_title">
                                    <span class="red">*</span><%=Resources.CRMTREESResource.EventContact %> <%=Resources.CRMTREESResource.EventDuration %>
                                </td>
                                <td class="table_cont" colspan="2">
                                    <div>
                                        Event Start date <input id="Ex_EV_Act_S_dt" class="easyui-datebox" style="width:100px;"/>
                                        duration <input id="Ex_EV_Act_End_dt" class="easyui-numberbox" style="width:50px;"/> days
                                      </div>
                                    <div style="margin-top:10px;">
                                        Start Announcement <input id="Ex_EV_Start_dt" class="easyui-numberbox" style="width:50px;"/> days prior to event For <input id="Ex_EV_End_dt" class="easyui-numberbox" style="width:50px;"/> days
                                     </div>  
                                </td>
                            </tr>
                            <%-- 推荐工具--%>
                            ...
                            <%-- 预算--%>
                            <tr>
                                <td class="table_title"><%=Resources.CRMTREESResource.EventBudget %>
                                </td>
                                <td class="table_cont" colspan="2">
                            ...
                            <tr>
                                ...
                                <td class="table_cont" colspan="2">
                                  ...
                                  <%--  <select id="ddl_Succ" class="js_enter boder_height" style="width: 500px;">
                                    ...
                                    <div id="p" class="easyui-panel" title="Please click on the select Matrix" style="width: 100%; height: 200px; padding: 5px;"
                            ...
                            <%-- Campagin消息文件名--%>
                            <tr>
                                <td class="table_title"><span class="red">*</span><%=Resources.CRMTREESResource.EventMessageFile %></td>
                                <td class="table_cont" colspan="2">
                    ...
                    <div class="detail_menu StdBtn1">
                        ...
                        <a class="btnBack" href="javascript: void(0);">Send For Approval</a>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        $(function () {
            $.getWordById(4036, function (o) {
                if (o) {
                    if (o.value == 0) {
                        $("#pnl_status").panel({ title: "Status: " + o.text }).panel('doLayout');
                        return false;
                    }
                }
            });

            $.post('/handler/Reports/Reports.aspx', { o: JSON.stringify({ action: 'getReportData', RP_Code: 83 }) }, function (rows) {
                ...
                for (var i = 0, len = rows.length; i < len; i++) {
                    ...
                    $('#acc_users').accordion('add', {
                        title: dataRow.Name,
                        content: '<div style="width:100%;height:80px"></div>',
                        selected: false
                    });
                }
            }, "json");
