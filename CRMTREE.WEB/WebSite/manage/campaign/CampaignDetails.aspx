<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CampaignDetails.aspx.cs" Inherits="manage_campaign_CampaignDetails" %>
...
<body>
    <div class="easyui-panel" data-options="title:'Campaign Editor',fit:true" style="overflow:hidden;padding:5px;">
    <table id="frm_campaign" class="tbl" cellpadding="0" cellspacing="0">
            ...
            <td class="td" style="width:300px;vertical-align:top;" colspan="2">
                <div class="easyui-layout" data-options="fit:true">
                    <div data-options="region:'center',title:'<%=Resources.CRMTREEResource.camp_Approval_Process %>'" style="padding:5px;overflow-y:scroll;">
                        <div id="ctrl_users" class="easyui-accordion" data-options="selected:null" ></div> 
                    </div>
                </div>
            </td>
        </tr>
        ...
        <tr id="ex_tr_budget" class="">
            ...
            <td class="td" colspan="3">
                Total: <input id="CG_Budget" class="easyui-numberbox" style="width:80px;"/><span style="width:15px; display:inline-block;"></span>
                Paid by Dealer <input id="EX_Paid" class="easyui-numberbox" style="width:80px;"/>%<span style="width:15px; display:inline-block;"></span>
                Dealer Pays <input id="EX_Dealer_Pays" class="easyui-textbox" data-options="disabled:true" style="width:80px;"/><span style="width:15px; display:inline-block;"></span>
                OEM Pays <input id="EX_OEM_Pays" class="easyui-textbox" data-options="disabled:true" style="width:80px;"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="td" colspan="3"> 
                ...
                <div id="control_btn_group" class="icon-file" style="float:left;display:none;padding-left:20px;">
                    <a class="easyui-linkbutton" id="btnFileView" data-options="plain:true,iconCls:'icon-search',onClick:_campaign.file.view">View</a>
                </div>
            </td>
        </tr>
    </table>
...
<script type="text/javascript">
    ...
    var _campaign = {
        ...
        getReportData: function () {
            $.post(_s_url_report, {
                o: JSON.stringify({
                    ...
                    RP_Code: 85,
                    queryParams:[{ EX_Name: "CT", EX_Value: _params.CT, EX_DataType: 'int' }]
                })
            }, function (rows) {
        ...
        */
        ...
        init: function () {
            ...
            $("#CG_Budget").numberbox({
                onChange: function (newValue, oldValue) {
                    var paid = $("#EX_Paid").numberbox('getValue');
            ...
            if (_params.CG_Code > 0) {
                ...
                $.post(_s_url, { o: s_params }, function (res) {
                    if ($.checkResponse(res) && res.campaign) {
                        ...
                        $("#aView").attr("href", _campaign.file._fullPath);
        ...
        file: {
            _fullPath: '',
            view: function () {
                var myWindow = window.open(_campaign.file._fullPath, "view", 'status=no,location=no,resizable,toolbar=no,scrollbars,width=800,height=500', "_blank");
    ...
    function SetTitle() {
        ...
        var cts = {
            ...
            attract: "Attract",
            maintain: "Maintain",
            lettersAndTips: "News Letters/Tips",
        ...
        cts["_51"] = cts.attract;
        cts["_2"] = cts.maintain;
        cts["_52"] = cts.maintain;
        cts["_35"] = cts.lettersAndTips;
        cts["_85"] = cts.lettersAndTips;
        cts["_73"] = cts.brandBuilding;
        cts["_53"] = cts.brandBuilding;
        cts["_20"] = cts.surveys;
        cts["_70"] = cts.surveys;
        cts["_30"] = cts.reminders;
        cts["_80"] = cts.reminders;

        $("#ex_campaign_title").panel({ title: "Campaign Editor:" + $.trim(cts["_" + ct]) });
    }
