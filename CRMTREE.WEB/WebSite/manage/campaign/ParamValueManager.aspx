<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ParamValueManager.aspx.cs" Inherits="manage_campaign_ParamValueManager" %>
...
<body>
    <div class="easyui-layout" data-options="fit:true">
        ...
        <div data-options="region:'south',border:false" style="height:38px;text-align:right;overflow:hidden;border-top: 1px solid #B1C242;padding-top:5px;padding-right:10px;">
            <a class="easyui-linkbutton" data-options="iconCls:'icon-ok',onClick:_param_value.accept" style="width:80px;"><%=Resources.CRMTREEResource.cm_cars_buttonos_accept%></a>
...
<script type="text/javascript">
    ...
    _params.PV_CG_Code = (_params.PV_CG_Code > 0 ? _params.PV_CG_Code : 0);
    _params.PV_Type = (_params.PV_Type > 0 ? _params.PV_Type : 1);
    ...
    var _param_value = {
        ...
        accept: function () {
            ...
            _param_value.get();
            //window.top[_params._winID]._campaign.bParamValue = true;
            //window.top[_params._winID]._campaign.paramValue = _param_value.data;
            if (_params.PV_Type == 1) {
                window.top[_params._winID]._campaign.updateTargeted(true, _param_value.data);
            }

            if (_params.PV_Type == 2) {
                window.top[_params._winID]._Camp_Methods.updateTargeted(true, _param_value.data);
            }
        ...
        get: function () {
            ...
            $.each(_param_value.data, function (i, o) {
                ...
                11 : List of Car Year,Make & Models
                12 : List of Car Year,Make, Models, and Style 
    ...
    */
    ...
    _param_value.create = function () {
        ...
        $.each(_param_value.data, function (i, d) {
            //d.PL_Type d.PV_Val d.PL_Default
            var c = '';
            var v = d.PV_Val;
            ...
            switch (d.PL_Type) {
                ...
                case 11:
                    ...
                    _param_value.ctrols.combobox = [id + '_1', id + '_2'];//id + '_0',
                    break;
                case 12:
                    c = //'<input id="' + id + '_0" class="easyui-combobox" data-options="editable: true,required:true,novalidate:true"/>'
                        //+
                    ...
                    _param_value.ctrols.combobox = [ id + '_1', id + '_2', id + '_3'];//id + '_0',
                    break;
                    //case 13:
    ...
    $(function () {
        if (_params.PV_Type == 1) {
            _param_value.data = window.top[_params._winID]._campaign.paramValue;
        }

        if (_params.PV_Type == 2) {
            _param_value.data = window.top[_params._winID]._Camp_Methods.getParamValue();
        }
        ...
        $.post(_s_url, {
            ...
            _param_value.data = $.map(data, function (d) {
                ...
                return d.PL_Code > 0 ? {
                    ...
                    , PL_Type: d.PL_Type
                    , PV_Val: val != "" ? val : $.trim(d.PL_Default)//d.PV_CG_Code > 0 ? $.trim(d.PV_Val) : $.trim(d.PL_Default)
                } : null;
            });
