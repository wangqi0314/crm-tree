<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FileEdit.aspx.cs" Inherits="manage_campaign_FileEdit" %>
...
<body style="margin: 0px; padding: 0px;">
    <form id="form1" runat="server">
        <div id="EditFile" style="width: 760px; height: 555px; margin: 0px; padding: 0px;">
        </div>
        <div id="tests"></div>
        <script type="text/javascript">
            ...
            ue.ready(function () {
                var filenames = GetQueryString("filename");
                $.ajax({
                    type: "POST",
                    dataType: "text",
                    url: "/handler/ajax_campaign.aspx",
                    data: { action: "edit_file", fullname: filenames },
