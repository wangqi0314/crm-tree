<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Campaign_ALL.aspx.cs" Inherits="manage_campaign_Campaign_ALL" %>
...
<body>
    <form id="form1">
        <div id="container">
            ...
            <div id="content">
                <%--<div class="nav_infor" style="background-color: #F5EDD1"><%= Resources.CRMTREEResource.Campaign %></div>--%>
    ...
    <script type="text/javascript">
        ...
        $("#ctrl_iframe").attr("src", "/manage/campaign/Campaign_ALL_Navigation.aspx?_cmd=cp" + params);
    </script>
</body>
</html>