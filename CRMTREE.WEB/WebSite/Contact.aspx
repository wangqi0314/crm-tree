...
<body>
    <form id="form1" runat="server">
        <div id="container">
            ...
            <div id="cont_login">
                 <div class="log_title" style="font-size:18px; font-weight:bold;"><%=Resources.CRMTreeLogin.Contact_Title %></div>
                <div class="lg_Contbox">
                    <div class="Title" > <%=Resources.CRMTreeLogin.Cont_Title1 %></div>
                    <div class="Body"><%=Resources.CRMTreeLogin.Cont_Cont1 %></div>
                    <div class="Title" > <%=Resources.CRMTreeLogin.Cont_Title2 %></div>
                    <div class="Body"><%=Resources.CRMTreeLogin.Cont_Cont2 %></div>
                 </div>
            </div>
