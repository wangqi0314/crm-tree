...
function FileGroupProgress()
{
    ...
    if (!this.fileGroupElement)
    {
        ...
        this.fileSumSpan.appendChild(document.createTextNode("Upload Progress："));
        ...
        this.spanTextU.appendChild(document.createTextNode("，Uploaded"));
        ...
        this.spanText.appendChild(document.createTextNode("，Total Size"));
