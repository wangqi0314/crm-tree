...
function FileProgress(file, targetid) {
    ...
    if (!this.fileProgressElement) {
        ...
        this.filenameSpan.id = "sp_fname_" + file.id;
        ...
        this.percentSpan.innerHTML = "(Wait for upload...)";
        ...
        this.hrefControl.id = "a_Edit" + file.id;
        this.hrefControl.accessKey = file.name;
        this.hrefControl.className = "js_Edit";

        this.hrefControl.innerHTML = "Edit";
        ...
        this.hrefControl.id = "a_" + file.id;
        this.hrefControl.accessKey = file.name;
        this.hrefControl.className = "js_delete";

        this.hrefControl.innerHTML = "Delete";
        ...
        this.hrefControl.id = "a_View" + file.id;
        this.hrefControl.accessKey = file.name;
        this.hrefControl.className = "js_View";

        this.hrefControl.innerHTML = "View";
        this.hrefSpan.appendChild(this.hrefControl);
        this.fileProgressElement.appendChild(this.hrefSpan);
