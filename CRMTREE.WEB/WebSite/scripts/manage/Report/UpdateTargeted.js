...
function InitializationPage() {
    ...
    if (rp_Code != null && rp_Code != "") {
        $.ajax({
            type: "POST",
            dataType: 'json',
            contentType: "application/json; charset=utf-8",
            url: "Update_Targeted.aspx/getParamterslist",
...
function MakeList(i, value) {
    $.ajax({
        ...
        url: "/manage/campaign/UpdateTargeted.aspx/getMyCarMakeList",
...
function CT_Makes(i, CM_Code) {
    $.ajax({
        type: "POST", dataType: "json", contentType: "application/json; charset=utf-8",
        url: "/manage/campaign/UpdateTargeted.aspx/getCarMake",
...
function ModeList(i, MK_Code, value) {
    $.ajax({
        type: "POST", dataType: "json", contentType: "application/json; charset=utf-8",
        url: "/manage/campaign/UpdateTargeted.aspx/getMyCarModeList",
...
function CT_Mode(i, CM_Code) {
    $.ajax({
        type: "POST", dataType: "json", contentType: "application/json; charset=utf-8",
        url: "/manage/campaign/UpdateTargeted.aspx/getMyCarMode",
        data: "{i:" + i + ",CM_Code:" + CM_Code + "}", async: false,
        success: function (data) {
            if (data.d != null) {
                var Mode = data.d;
...
function StyleList(CM_Code, value) {
    $.ajax({
        type: "POST", dataType: "json", contentType: "application/json; charset=utf-8",
        url: "/manage/campaign/UpdateTargeted.aspx/getMyCarStyleList",
...
function CT_Style(CS_Code) {
    $.ajax({
        type: "POST", dataType: "json", contentType: "application/json; charset=utf-8",
        url: "/manage/campaign/UpdateTargeted.aspx/getMyCarStyle",
