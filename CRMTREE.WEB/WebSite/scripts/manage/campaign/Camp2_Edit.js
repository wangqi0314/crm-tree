...
Matrix.SuccessMatrix = function () {
    $.ajax({
        ...
        url: "Camp2_Edit.aspx/getSuccMatrxList_s", data: null, async: false,
...
Matrix.SuccessMatrix.Select = function () {
    $("#Succ").combobox({
        onChange: function (newValue, oldValue) {
            ...
            $.ajax({
                type: "POST", dataType: "json", contentType: "application/json; charset=utf-8",
                url: "Camp2_Edit.aspx/getSuccMatrx_s", data: "{Code:" + _id + ", Code_s:'" + newValue.toString() + "'}", async: false,
                success: function (data) {
                    if (data.d != null) {
                        var SuccMatrix = data.d.SuccMatrixList;
                        $(".succ_Matri_param").empty();
        ...
        $.open({
            ...
            callback: function (action, iframe) {
                if (action == 'ok') {
                    ...
                    $.ajax({
                        type: "POST", dataType: "json", contentType: "application/json; charset=utf-8", url: "Camp2_Edit.aspx/getReplaceReports",
...
function Binding_Defalut_ddl_Targeted() {
    var CG_Code = getUrlParam("id");
    $.ajax({
        type: "POST", dataType: 'json', contentType: "application/json; charset=utf-8", url: "Camp2_Edit.aspx/getReplaceReport",
...
function Binding_EventPerson() {
    $.ajax({
        type: "POST", dataType: "json", contentType: "application/json; charset=utf-8",
        url: "Camp2_Edit.aspx/getEventPersonList", data: null, async: false,
        success: function (data) {
            if (data.d != null) {
...
function Binding_EventTools() {
    $.ajax({
        type: "POST", dataType: "json", contentType: "application/json; charset=utf-8",
        url: "Camp2_Edit.aspx/getEventToolsList", data: null, async: false,
        success: function (data) {
            if (data.d != null) {
