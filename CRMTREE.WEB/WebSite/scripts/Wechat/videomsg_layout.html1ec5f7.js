...
function e() {
var e = $.trim(c.val());
return /^[0-9]+$/.test(e) && !isNaN(parseInt(e)) && parseInt(e) > 0 ? parseInt(e) >= i ? (s.err("投放数量只能小于10亿"), !1) : parseInt(e) <= 0 ? (s.err("投放数量只能是正整数"), !1) : e : (s.err("投放数量只能是正整数"), !1);
}
function t() {
this.currentStep = 1, this.step = new u({
names: [ "1 选择卡券", "2 投放设置" ],
container: $(".js_step_container", a)
}), this.total_length = 2, this.$btns = a.find(".js_btn_p"), this.step_btns = {
"1": $(this.$btns[0]),
"2": this.$btns.slice(1)
}, this.$contents = a.find(".js_step_content"), this.go(this.currentStep);
}
var n = this.opt, r = this, i = 1e9, o = $(template.compile(this._html)()).popup({
title: "投放卡券",
autoShow: !1,
buttons: [ {
text: "下一步",
...
card_id: e,
success: function(e) {
e === !1 ? s.err("没有“审核通过”的门店。确认有至少一个“审核通过”的门店后可进行投放。") : e === !0 && (a.find(".js_card_title").text(t.title), h.next(), $(".js_source", a).text(n.source), n.source == "嵌入图文消息素材" ? $(".js_source_tips", a).show() : $(".js_source_tips", a).hide());
}
});
}
}, {
...
this.$send_popup = o;
var a = o.popup("get"), f = a.find(".js_num_radio").checkbox(), c = a.find(".js_send_num");
...
go: function(e) {
e >= 1 && e <= this.total_length && (this.currentStep = e), this.step.go(this.currentStep), this.$btns.hide(), this.step_btns[this.currentStep].show(), this.$contents.hide(), a.find(".js_step" + this.currentStep).show();
}
};
var h = new t;
},
