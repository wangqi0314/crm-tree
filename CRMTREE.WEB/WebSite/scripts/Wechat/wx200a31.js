try {
    (function (e) {
        ...
        wx.resPath = location.hostname == "mp.weixin.qq.com" ? "https://res.wx.qq.com" : "",
        wx.injectXss = function (e, t, n) {
            function r(e) {
...
define("common/wx/Tips.js", [], function (e, t, n) {
    try {
        var r = +(new Date);
        "use strict";
        var i = t, s = {
        ...
        function u(e, t, n) {
            $(".JS_TIPS").remove(),
            o = $(template.compile('<div class="JS_TIPS page_tips {type}" id="wxTips_'+ (new Date).getTime() + '"><div class="inner">{=msg}</div></div>')({ type: e || "error", msg: t })).appendTo("body").fadeIn(),
            a.delay(n || s.delay, o);
        }
        function a(e) {
