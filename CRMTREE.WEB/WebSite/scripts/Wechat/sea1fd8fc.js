(function (e, t) {
    ...
    nt.prototype.load = function () {
        ...
        for (var i = 0; i < n; i++)
            r = nt.get(t[i]),
                r.status < tt.LOADED ? r._waitings[e.uri] = (r._waitings[e.uri] || 0) + 1 : e._remain--;
        if (e._remain === 0) {
            e.onload();
            return;
        }
        ...
        for (i = 0; i < n; i++)
            r = Q[t[i]],
                r.status < tt.FETCHING ? r.fetch(s) : r.status === tt.SAVED && r.load();
        for (var o in s)
    ...
    nt.prototype.onload = function () {
        ...
        for (n in t)
            t.hasOwnProperty(n) && (r = Q[n],
                r._remain -= t[n],
                r._remain === 0 && r.onload());
        delete e._waitings,
        delete e._remain;
    },
    ...
    r.preload = function () {
        ...
        return t += " " + A.cookie, t.replace(/(seajs-\w+)=1/g,
            function (t, n) {
                e.push(n);
            }), e;
    }(),
...
(function (e) {
    ...
    if (r.test) {
        var d = e.test || (e.test = {});
        d.uris2paths = l,
        d.paths2hash = paths2hash;
    }
    define("seajs-combo-debug", [], {});
})(seajs);;
(function (e) {
    var t = location.hostname == "mp.weixin.qq.com" ||
        location.hostname == "mpc.weixin.qq.com" ||
        location.hostname == "mpd.weixin.qq.com" ? "https://res.wx.qq.com/" : "/",
        n = function (e) {
            var t = e.lastIndexOf(".");
            return t >= 0 ? e.substring(t) : "";
        };
        ...
        map: [
            function (t) {
                var i = n(t),
                    s = e.data.base,
                    o = t.substr(s.length);
                if (typeof MODULES == "undefined" || !MODULES[o])
                    return s.replace("/c/=", "") + r[i] + o + "?20130807";
                var u = MODULES[o], a = u;
