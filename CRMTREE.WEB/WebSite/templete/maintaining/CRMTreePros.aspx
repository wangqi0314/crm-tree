<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CRMTreePros.aspx.cs" Inherits="templete_report_Pros" %>
...
<script type="text/javascript">
    ...
    var _s_url_account='/handler/Reports/'
    //界面地址参数
...
+ '                    </div>'
+ '                </div>'
+ '                <div title="' + language.tabs.preferences + '" data-options="id:\'vis\',iconCls:\'icon-customer-preferences\'">'
+ '                </div>'
+ '                <div title="' + language.tabs.account + '" data-options="id:\'app\',iconCls:\'icon-customer-visits\'">'
