<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DealershipManager.aspx.cs" Inherits="templete_report_DealershipManager" %>
    ...
    <form id="form1">
        <div id="container">
            ...
            <div id="content">
                ...
                <div class="cont_box" style="height: 535px; padding: 0px;">
                    <iframe src="/templete/usercontrol/DealershipManager.aspx" style="width:100%;height:100%;" frameborder="0" border="0" scrolling="no"></iframe>
                </div>
            </div>
