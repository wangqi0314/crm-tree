<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmployeeManager.aspx.cs" Inherits="templete_report_EmployeeManager" %>
...
+ '                                <td>'
+ '                                    <input id="DE_Ignore" type="checkbox" checked="false"/>'
+ '                                </td>'
+ '                            </tr>'
+ '                            <tr>'
...
+ '                                    <input id="AU_UG_Code" class="easyui-combobox" data-options="'
+ '                                       valueField:\'value\', textField: \'text\', groupField:\'group\' "/>'
+ '                                </td>'
+ '                            </tr>'
//+ '                            <tr>'
...
+ '    </div>';
        ...
        function Save() {
            ...
            params.personal = $.extend({}, _personal.get(), _account.get(), { DE_Vacation_St: $("#DE_Vacation_St").datebox('getValue'), DE_Vacation_En: $("#DE_Vacation_En").datebox('getValue') });
            //params.personal.AU_Type = 0;
            params.schedule = _schedule.get();

            if (_params.TP > 0) {
                params.personal.DE_UType = _params.TP
            }
            if (_params.AD > 0) {
                params.personal.DE_AD_OM_Code = _params.AD
            }
