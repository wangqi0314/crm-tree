<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShunovoLogin.ascx.cs" Inherits="control_ShunovoLogin" %>
...
<div id="top" style="height: 75px;">
    ...
    <div class="left" style="background: url(/images/Login.png) no-repeat; width: 310px; height: 64px; margin-top: 10px;">
        <a href="#">
            <div class="logo"></div>
        </a>
        <%--        <div class="tagline" style="margin:0px;height:20px; margin-top:-4px;"><%= Resources.CRMTREESResource.topLogo %></div>--%>
    </div>
    <div class="right" style="width: 690px; height: 70px">
        <div class="infor">
