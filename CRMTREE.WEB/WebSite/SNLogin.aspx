<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SNLogin.aspx.cs" Inherits="Login" %>

<%@ Register Src="~/control/CrmTreebottom.ascx" TagPrefix="uc1" TagName="CrmTreebottom" %>
<%@ Register Src="~/control/ShunovoLogin.ascx" TagPrefix="uc1" TagName="CrmTreetopLogin" %>
...
<head>
    ...
    <title><%=Resources.CRMTreeLogin.LoginTitel %></title>
                    ...
                    <div class="log_cont">
                        <div class="log_module1">
                            <ul>
                                ...
                                <li><a href="#" class="read_more"><%=Resources.CRMTREESResource.LoginReadMore %></a></li>
                            </ul>
                        </div>
                        <div class="log_module1">
                            <ul>
                                ...
                                <li><a href="#" class="read_more"><%=Resources.CRMTREESResource.LoginReadMore1 %></a></li>
                            </ul>
                        </div>
                        <div class="log_module1">
                            <ul>
                                ...
                                <li><a href="#" class="read_more"><%=Resources.CRMTREESResource.LoginReadMore2 %></a></li>
                            </ul>
                        </div>
                        <div class="log_module2">
                            <ul>
                                ...
                                <li><a href="#" class="read_more"><%=Resources.CRMTREESResource.LoginReadMore3 %></a></li>
                            </ul>
                        </div>
                        <div class="cl"></div>
                        <div class="log_bot">
                            <div class="log_seaos">
                                <ul>
                                    ...
                                    <li><img src="images/log_img1.jpg" /></li>
                            ...
                            <div class="log_service">
                                ...
                                <ul>
                                    <li><a href="#"><%=Resources.CRMTREESResource.Loginlower4 %></a></li>
                                    <li><a href="#"><%=Resources.CRMTREESResource.Loginlower5 %></a></li>
                                    <li><a href="#"><%=Resources.CRMTREESResource.Loginlower6 %></a></li>
                                </ul>
                            </div>
                            <div class="log_test">
                                <%=Resources.CRMTREESResource.Loginlower3 %>
                                <ul>
                                    <li class="log_head"><img src="images/log_head.jpg" /></li>
