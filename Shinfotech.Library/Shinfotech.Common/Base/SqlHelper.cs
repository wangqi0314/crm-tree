...
namespace ShInfoTech.Common
{
    ...
    public sealed class SqlHelper
    {
        ...
        private SqlHelper() { }
        private static string AConnectionStringName = "CRMTREEConnectionString";
        /// <summary>
        ...
        public static string GetConnectionString()
        {
            try
            {
                return ShInfoTech.Common.Tools.DecryptSqlPwd(AConnectionStringName);
        ...
        {
            return SqlHelper.ExecuteNonQuery(GetConnectionString(), commandType, commandText);
        }
        /// <summary>
        /// 采用默认连接 执行命令
        /// </summary>
        ...
        {
            return SqlHelper.ExecuteDataset(CommandType.Text, commandText);
        }
        /// <summary>
        /// 执行指定类型的 命令
        /// </summary>
        ...
        {
            return SqlHelper.ExecuteDataset(GetConnectionString(), commandType, commandText);
        }
        /// <summary>
        /// 采用默认连接 执行命令
        /// </summary>
        ...
        {
            return SqlHelper.ExecuteReader(CommandType.Text, commandText);
        }
        /// <summary>
        /// 执行指定类型的 命令
        /// </summary>
        ...
        {
            return SqlHelper.ExecuteReader(GetConnectionString(), commandType, commandText);
        }
        /// <summary>
        /// 采用默认连接 执行命令
        /// </summary>
        ...
        {
            return SqlHelper.ExecuteScalar(CommandType.Text, commandText);
        }
        /// <summary>
        /// 执行指定类型的 命令
        /// </summary>
