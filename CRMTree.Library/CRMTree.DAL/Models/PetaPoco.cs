...
namespace PetaPoco
{
    ...
    public class Database : IDisposable
    {
        ...
        public Database(string connectionStringName)
        {
            ...
            _connectionString = DecryptSqlPwd(_connectionString);
            _providerName = providerName;
            CommonConstruct();
        }

        public string DecryptSqlPwd(string connectionStr)
        {
            ...
            foreach (string s in str)
            {
                if (s.Contains("User ID="))
                {
                    ...
                    ss = DecryptDES(ss, "Shunovo20150701");
        ...
        public T ExecuteScalarCount<T>(string sql, params object[] args)
        {
            try
            { 
        ...
        public Page<T> Page<T>(long page, long itemsPerPage, string sqlCount, object[] countArgs, string sqlPage, object[] pageArgs)
        {
            ...
            var result = new Page<T>
            {
                ...
                TotalItems = ExecuteScalarCount<long>(sqlCount, countArgs)
            };
        ...
        public Page<T> Page<T>(long page, long itemsPerPage, string sql, params object[] args)
        {
            ...
            return Page<T>(page, itemsPerPage, sql, args, sqlPage, args);
        }
